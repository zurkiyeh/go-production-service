...
// Why is this necessary? We might not be able to populate a comment directly from the db because db schema allows nill values. This way we dont have to worry about nill values
